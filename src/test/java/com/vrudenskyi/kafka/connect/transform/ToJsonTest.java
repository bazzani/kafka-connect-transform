...
public class ToJsonTest {
    ...
    public void shouldNotConvertNullValue() {
        // given
        SourceRecord sourceRecord = new SourceRecord(null, null, "testTopic", Schema.OPTIONAL_STRING_SCHEMA, null);
    ...
    public void shouldConvertStructWithAllCorePrimitiveSchemaTypesToJson() {
        ...
        SourceRecord sourceRecord = new SourceRecord(null, null, "testTopic", valueSchema, value);
